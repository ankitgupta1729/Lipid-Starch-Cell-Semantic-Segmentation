...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 17:22:55 2024
...
image_directory = 'images/train_images/'
mask_directory = 'images/train_masks/'
...
model_Unet.compile(loss='categorical_crossentropy', optimizer=Adam(lr = 1e-3), 
